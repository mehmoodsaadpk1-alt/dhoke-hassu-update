...
export const mockDeals: DealItem[] = [
  ...
  },
  {
    ...
    description: 'Prioritize your family health! Get completely free Blood Sugar and Blood Pressure examinations with any medicine purchase of Rs. 500 or more. Consult our in-house qualified pharmacist for free health advice.',
  ...
  {
    id: 'd4',
    title: 'Rs. 200 Discount on Stitching of Your Second Ladies Suit',
    category: 'Services',
    businessName: 'Rawal Boutique & Stitching Center',
    description: 'Get ready for the upcoming wedding season! If you bring two or more unstitched suits for stitching, you will get flat Rs. 200 discount on the stitching of the second suit. Premium customized design fit guaranteed by Master Malik!',
    area: 'Street 4, Dhoke Hassu',
    discountText: 'Save Rs. 200 On 2nd Suit',
  ...
  {
    id: 'd5',
    title: 'Save Rs. 150 on Sufi Cooking Oil 5 Liter Can',
    category: 'Shopping',
    businessName: 'Al-Hamd General Store & Mart',
    description: 'Exclusive kitchen savings! Purchase Sufi Cooking Oil (5 Liter Can) and get an instant cash discount of Rs. 150. Stock your pantry with premium household products at wholesale rates in Dhoke Hassu.',
    area: 'Street 9, Near Jamia Masjid Ghausia, Dhoke Hassu',
    discountText: 'Rs. 150 Off Sufi 5L Oil',
    ...
    recentPosts: [
      {
        ...
        author: 'Hamza Mobile',
        avatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&q=80&w=120',
        content: 'Registration is now OPEN for the Dhoke Hassu Tape-ball Night Cup! Entry fee is Rs. 1000 per team. Winner prize is Rs. 15000 cash. Register by calling me directly.',
        time: 'Yesterday',
        pinned: true
      }
    ]
