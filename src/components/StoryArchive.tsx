      ...
      <div className="bg-white rounded-3xl w-full max-w-4xl h-[85vh] flex flex-col overflow-hidden shadow-2xl relative">
        ...
        <div className="p-4 border-b flex flex-col sm:flex-row gap-4 bg-white">
          ...
          <div className="relative">
            <Calendar className="w-5 h-5 absolute start-3 top-1/2 -translate-y-1/2 text-slate-400" />
            <input 
              type="month" 
              value={filterMonth}
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
              {filteredStories.map((story, idx) => (
                <div key={story.id} className="group relative aspect-[9/16] bg-slate-800 rounded-2xl overflow-hidden cursor-pointer shadow-sm hover:shadow-md transition">
                  ...
                  <div className="absolute top-0 start-0 end-0 p-2 bg-gradient-to-b from-black/60 to-transparent flex items-center justify-between text-white z-20 pointer-events-none">
