...
export default function App() {
      ...
      try {
        ...
        if (!error && profile) {
          ...
          return {
            ...
            countryId: profile.country_id || (parsedSocialLinks as any)?.countryId || undefined,
  ...
  useEffect(() => {
    if (user && (!user.countryId || !user.provinceId || !user.cityId || !user.areaId)) {
